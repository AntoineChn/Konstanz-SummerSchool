...
The `bnlearn` package is the most complete and popular package for Bayesian Networks available to the date in `R`.
...
$$\frac{\Pr(L|S = \text{yes})}{\Pr(L|S = \text{no})} =\frac{0.11769384}{0.01368209} = 8.6020348$$ 
...
- Calculate (by hand) the ratio between $\Pr(S|L = yes)$ and $\Pr(S|L = no)$
