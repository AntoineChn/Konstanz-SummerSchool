...
- What are causal relationships in your opinion?
- Use a BN structure (a DAG) to represent your causal relationships.
- Encode your BN structure with `model2network()` in `R`
...
dag_mydag = model2network("[A][S][T][L|S][B|S][D|B][E|T:L][X|E]")
# Check the class of dag_mydag
class(dag_mydag)
# Plot
...
### Data-driven approach : Structure learning
