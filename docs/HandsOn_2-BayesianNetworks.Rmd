...
- Estime following probabilties using `cpquery()` 
    - $\hat{\mathbb{P}} (L)$ : Probability of an individual having lung cancer 
    - $\hat{\mathbb{P}} (L|S = no)$ : Probability of an individual having lung cancer given that he/she has smoking history 
    - $\hat{\mathbb{P}} (L|S = yes)$ : Probability of an individual having lung cancer given that he/she has **NO** smoking history.
- Cluculate the ratio between $\mathbb{P}(L|S = yes)$ and $\mathbb{P}(L|S = no)$
