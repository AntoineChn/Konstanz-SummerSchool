...
Note: c.f. <button class="btn btn-primary" data-toggle="collapse" data-target="#YoutubeInstallRMac"> Video : "How to Install R"</button>
...
Note: c.f. <button class="btn btn-primary" data-toggle="collapse" data-target="#YoutubeInstallRWin"> Video “Install R for Mac” </button> 
<div id="YoutubeInstallRWin" class="collapse">  
<div class="boxed">

<iframe width="630" height="472"
src="https://www.youtube.com/embed/uxuuWXU-7UQ">
</iframe>
